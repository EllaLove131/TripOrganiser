 ...
 * @author Ella Love
 *
 *         Creates the trip fees display panel that displays trip fee
 *         information when added to a panel. Contains both the entrance fee and
 *         sundry fee. Allows for the setting of values within the text labels.
 */
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(
								groupLayout.createSequentialGroup()
										.addContainerGap().addComponent(lblFees, GroupLayout.PREFERRED_SIZE, 51,
												GroupLayout.PREFERRED_SIZE))
						.addGroup(groupLayout.createSequentialGroup().addGap(29).addGroup(groupLayout
								.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
										.addComponent(lblSundry, GroupLayout.PREFERRED_SIZE, 43,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(lblSundryDb, GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE))
								.addGroup(groupLayout.createSequentialGroup()
										.addComponent(lblEntrance, GroupLayout.PREFERRED_SIZE, 53,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED)
						...
						groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup().addContainerGap().addComponent(lblFees)
										...
										.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
												.addComponent(lblEntrance).addComponent(lblEntranceDb))
										.addPreferredGap(ComponentPlacement.RELATED)
										.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
												.addComponent(lblSundry).addComponent(lblSundryDb))
